...
VirtIO drivers for Windows deserve their own post. I'll just point out the ISO containing everything can be downloaded from [the Github](https://github.com/virtio-win/virtio-win-pkg-scripts) page and that it needs to be mounted somewhere so you can grab the `viofs` drivers within.
